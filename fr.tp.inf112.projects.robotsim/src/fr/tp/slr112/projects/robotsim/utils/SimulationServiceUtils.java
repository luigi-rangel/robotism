package fr.tp.slr112.projects.robotsim.utils;
...
public class SimulationServiceUtils {
	 ...
	 public static final String DEFAULT_ID = "initial.factory";
	 ...
	 public static String getTopicName(final Factory factoryModel) {
		 return TOPIC + (factoryModel.getId() == null ? DEFAULT_ID : factoryModel.getId());
	 }
