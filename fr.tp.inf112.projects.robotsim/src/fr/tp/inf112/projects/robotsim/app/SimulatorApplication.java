...
import fr.tp.inf112.projects.robotsim.model.TestRobotSimSerializationJSON;
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
	        ...
	        public void run() {
				...
				Component factoryViewer = 
						new CanvasViewer(new RemoteSimulatorController(factory, new RemoteFactoryPersistenceManager(canvasChooser)));
